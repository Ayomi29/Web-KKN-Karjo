...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Membuat Post Baru</h1>
</div>
<div class="col-lg-8">
    <form action="/dashboard/adminpost" method="POST" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
...
<script>
    ...
    // fiur add file
    document.addEventListener('trix-file-access', function(e) {
        e.prevenDefault();
    })
